...
<header
    class={"sticky z-[10] top-0 duration-200 px-6 flex items-center justify-between border-b border-solid " +
        (y > 0
            ? " py-4 bg-zinc-950 border-blue-950"
            : " py-6 bg-transparent border-transparent")}
>
    <h1 class="font-medium">
        <b class="font-bold poppins">Frank</b> <span class="">Castiglione</span>
    </h1>
    <div class="sm:flex items-center gap-4 hidden">
        ...
        {/each}
        <!-- <button
            class="blueShadow relative overflow-hidden px-5 py-2 group rounded-full bg-blue-600 text-white"
        >
            <div
